      ...
      <div className="flex h-screen flex-col overflow-x-hidden bg-gray-50">
        ...
        <div className="py-20 rounded-md relative flex flex-col items-center justify-center antialiased">
          <div className="max-w-5xl mx-auto p-4">
            <h1 className="w-5xl mx-auto font-extrabold text-6xl text-center relative text-zinc-900">
              <span className="bg-gradient-to-r from-indigo-500 via-blue-500 mr-4 to-purple-500 bg-clip-text text-transparent">
                Streamline Discipline & Integrity
              </span>
              with AI-Driven Solutions
            </h1>
            <p className="max-w-3xl mx-auto text-lg text-center relative text-zinc-800 mt-4">
              Our platform combines advanced student discipline management with
              cutting-edge AI detection. Efficiently manage student behavior and
              ensure academic honesty with innovative technology.
            </p>
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8  overflow">
          <img
            src="https://play.tailwindcss.com/img/beams.jpg"
            alt="Decorative background"
            className="mt-40 absolute top-1/2 left-1/2 max-w-none -translate-x-1/2 -translate-y-1/2 overflow-hidden"
            width="1308"
            height="auto"
          />
            ...
            <div className="lg:pr-8 lg:pt-4">
              <div className="lg:max-w-lg mt-5">
                <p className="mt-2 text-3xl font-bold tracking-tight text-black sm:text-4xl">
                  <span className="text-black">Why should you choose</span>
                  <span className="bg-gradient-to-r from-zinc-800 via-zinc-600 to-zinc-900 bg-clip-text text-transparent">
                    HiveLabs?
                  </span>
                </p>

                <p className="mt-4 text-lg leading-8 text-zinc-700">
                  Discover how our platform enhances student discipline and
                  integrity with innovative features designed to support
                  educators and maintain academic standards.
                </p>
