...
export function Sidebar(): JSX.Element {
  ...
  return (
    <aside className="flex h-screen w-16 flex-col items-center overflow-y-auto border-r bg-white py-5 rtl:border-l rtl:border-r-0 dark:border-[#2e2e2e] dark:bg-[#1a1a1a]">
            ...
            <div>
              {!data ? (
                ...
                <img
                  ...
                  src={`https://thumbs.metrik.app/group/${data}`}
                  alt=""
                />
              )}
            </div>
      ...
      <div className="h-screen w-60 overflow-y-auto border-l border-r bg-white px-5 py-8 sm:w-64 dark:border-zinc-700 dark:bg-zinc-900">
        <div className="relative">
          ...
          <input
            type="text"
            className="w-full rounded-md border bg-white py-1.5 pl-10 pr-4 text-zinc-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-zinc-600 dark:bg-zinc-900 dark:text-zinc-300 dark:focus:border-blue-300"
            placeholder="Search"
          />
        </div>

        <nav className="-mx-3 mt-4 space-y-6 ">
          <div className="space-y-3 ">
            <label className="px-3 text-xs uppercase text-zinc-500 dark:text-zinc-400">
              analytics
            </label>

            <a
              className="flex transform items-center rounded-lg px-3 py-2 text-zinc-600 transition-colors duration-300 hover:bg-zinc-100 hover:text-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-800 dark:hover:text-zinc-200"
              href="#"
            >
              <svg
